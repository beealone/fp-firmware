...
#ifndef MAIN_PROG
extern int HIDCheckCard(char *buffer);
extern int CheckKeyPad(void);
extern int GetKeyPadValue(unsigned char *KeyValue);
extern void LCDWriteCenterStr(int row, char *str);
