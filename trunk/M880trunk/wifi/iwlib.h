...
/*
 *struct of scanning result. (liming)
 */
typedef struct iw_scan_result{
        char ap_name[128];
        char ap_address[128];
        int  qualvalue;
...
#if 0
int iw_check_addr_type(int skfd, const char *ifname);
#endif
#if 0
int iw_get_mac_addr(int	skfd, const char *name, struct ether_addr *eth, unsigned short *ptype);
#endif
