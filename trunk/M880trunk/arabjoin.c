...
const arab_t zwj = {0x20,0x20,0x20,0x20}; //zero-width joiner

const arab_t lamaleph[] = {
    {0xfefb,0xfefc,0,0},
    {0xfef9,0xfefa,0,0},
    {0xfef7,0xfef8,0,0},
    {0xfef5,0xfef6,0,0}
...
{0xfeef,0xfef0,0xfef4,0xfef3},  // 0x06cc //FARS YEH replaced by ARABIC YEH's forms
